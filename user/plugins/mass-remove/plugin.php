...
<p>
  ...
  <input type="checkbox" id="check_test" name="test" value="test" checked="checked" />Display results, do not delete. This is a test. (Uncheck to delete permanently.)</label>
</p>
