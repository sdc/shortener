...
function popularclicksextended_display_page() {
    ...
    // Specific weeks:
    show_specific_period( date( 'Y-m-d', strtotime( 'monday this week' ) ), 'week', null, 'this week (beginning ' . date( 'jS F Y', strtotime( 'monday this week' ) ) . ') (so far)' );
    show_specific_period( date( 'Y-m-d', strtotime( 'monday this week - 7 days' ) ), 'week', null, 'last week  (beginning ' . date( 'jS F Y', strtotime( 'monday this week - 7 days' ) ) . ')' );
    // Specific months:
